...
@lazySingleton
class CheckResetPasswordCodeUseCase extends UseCase<BaseState, String> {
  final AuthRepository repository;

  CheckResetPasswordCodeUseCase({required this.repository});

  @override
  Future<Either<Failure, BaseState>> call(params) async {
    return await repository.checkResetPasswordCode(resetPasswordCode: params);
  }
}
